...
contract PudgyPenguins is ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable {
    ...
    address public constant CREATOR_ADDRESS = 0x6F84Fa72Ca4554E0eEFcB9032e5A4F1FB41b726C;
    address public constant DEV_ADDRESS = 0xcBCc84766F2950CF867f42D766c43fB2D2Ba3256;
    ...
    function withdrawAll() public payable onlyOwner {
        ...
        _widthdraw(DEV_ADDRESS, balance.mul(35).div(100));
        _widthdraw(CREATOR_ADDRESS, address(this).balance);   
    }
